...
class MountRequest(BaseModel):
    ...
    label: str   = Field(..., description="e.g. my_drive  -> mounted at /mnt/drives/my_drive")
...
class AvailableDevice(BaseModel):
    ...
    label: str = Field(..., description="e.g. my_drive")
...
class Dirs(BaseModel):
    dirs: list[Dirs] = Field(..., description="e.g. list of directories")